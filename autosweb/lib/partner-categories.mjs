...
export const PARTNER_CATEGORIES = [
  ...
  { id: "autoatvizsgalas", label: "Autoátvizsgálás", sort_order: 4 },
  { id: "autoszerelo", label: "Autószerelő", sort_order: 5 },
  { id: "gumiszerelo", label: "Gumiszerelő", sort_order: 6 },
  { id: "lakatos", label: "Lakatos", sort_order: 7 },
  { id: "klimaszerelo", label: "Klímaszerelő", sort_order: 8 },
  { id: "autokozmetika", label: "Autókozmetika", sort_order: 9 },
  { id: "autovillamossag", label: "Autóvillamosság", sort_order: 10 },
];
