...
export const FORM_FIELD_CATALOG = [
  ...
  { field_key: "okmany_ervenyesseg", label: "Okmányok érvényessége", step: 1 },
  ...
  { field_key: "ajtok", label: "Ajtók száma", step: 2 },
  { field_key: "szemelyek", label: "Szállítható szem. száma", step: 2 },
  ...
  { field_key: "kornyezetvedelmi", label: "Környezetvédelmi oszt.", step: 2 },
  { field_key: "co2_kibocsatas", label: "CO₂-kibocsátás", step: 2 },
  ...
  { field_key: "felezo_valto", label: "Felező váltó", step: 2 },
  { field_key: "hajtas", label: "Hajtás", step: 2 },
  { field_key: "henger_elrendezes", label: "Henger-elrendezés", step: 2 },
  ...
  { field_key: "metalfeny", label: "Metál", step: 2 },
  { field_key: "tetto", label: "Tető", step: 2 },
  { field_key: "csomagtarto", label: "Csomagtartó", step: 2 },
  { field_key: "belso_azonosito", label: "Belső azonosító", step: 2 },
  ...
  { field_key: "hatso_nyari_szelesseg", label: "Hátsó nyári gumi szélesség", step: 2 },
  { field_key: "hatso_nyari_magassag", label: "Hátsó nyári gumi magasság", step: 2 },
  { field_key: "hatso_nyari_atmero", label: "Hátsó nyári gumi átmérő", step: 2 },
  ...
  { field_key: "hatso_teli_szelesseg", label: "Hátsó téli gumi szélesség", step: 2 },
  { field_key: "hatso_teli_magassag", label: "Hátsó téli gumi magasság", step: 2 },
  { field_key: "hatso_teli_atmero", label: "Hátsó téli gumi átmérő", step: 2 },
