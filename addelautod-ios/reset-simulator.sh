...
grep -q "CURRENT_PROJECT_VERSION = 29" "$DEST/AddElAutod.xcodeproj/project.pbxproj"
...
echo "    OK — commit: $COMMIT — app verzió 1.0.10 (build 29), Ajánlások fotók a csomagban"
