...
struct SearchScreen: View {
    ...
    /// Fehér fejléc: a logo a teljes szélességet kitölti, vágás nélkül (arány megmarad).
    private var homeHeader: some View {
        let top = statusBarHeight
        /// BymyLogo.png 1018×475 — teljes kép, sem felül, sem alul nem vágódik.
        let logoHeight = UIScreen.main.bounds.width * (475.0 / 1018.0)
