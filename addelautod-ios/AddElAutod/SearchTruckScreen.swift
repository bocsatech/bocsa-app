...
struct SearchTruckScreen: View {
    ...
    private var rakterBody: some View {
        VStack(spacing: 0) {
            ...
            Divider().padding(.leading, 16)
            rangeRow("Raktér hossza (mm)", \.rakterHosszTol, \.rakterHosszIg)
            Divider().padding(.leading, 16)
            rangeRow("Raktér szélessége (mm)", \.rakterSzelessegTol, \.rakterSzelessegIg)
            Divider().padding(.leading, 16)
            rangeRow("Raktér magassága (mm)", \.rakterMagassagTol, \.rakterMagassagIg)
            Divider().padding(.leading, 16)
            rangeRow("Doblemez-távolság (mm)", \.doblemezTavolsagTol, \.doblemezTavolsagIg)
        }
    }
