...
cp "$SOURCE/mac/Bymy-indito.command" "$HOME/Desktop/Bymy-indito.command"
chmod +x "$HOME/Desktop/Bymy-indito.command"
...
echo ""
echo "Kész. Indítsd: ~/Desktop/Bymy-indito.command"
echo "Böngésző: https://bymy.vercel.app/  majd Cmd+Shift+R"
