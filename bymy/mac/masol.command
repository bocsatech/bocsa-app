...
cp "$(dirname "$0")/Bymy-indito.command" "$HOME/Desktop/Bymy-indito.command" 2>/dev/null || true
chmod +x "$HOME/Desktop/Bymy-indito.command" 2>/dev/null || true
echo "  ✓ Asztali indító frissítve"

echo ""
echo "Következő lépések:"
echo "  1) Állítsd le a futó Bymy-et (Ctrl+C)"
echo "  2) Indítsd: ~/Desktop/Bymy-indito.command"
