#!/bin/bash
# Google / Apple / Facebook OAuth beállítás Bymyhez
set -euo pipefail
...
echo "══════════════════════════════════════"
echo " Bymy — Social OAuth"
echo "══════════════════════════════════════"
echo ""
echo "Config: $TARGET"
echo "Példa:  $EXAMPLE"
echo ""
echo "1) publicBaseUrl = a domained (pl. https://bymy.vercel.app / később bymy.hu)"
...
echo "   → .p8 kulcs ide: ~/.bymy/AuthKey_….p8"
echo "   → apple.enabled=true + clientId/teamId/keyId/privateKeyPath"
echo ""
echo "Indítsd újra a Bymyet a mentés után."
echo ""
