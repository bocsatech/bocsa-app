...
export default function MachineAddForm({
  ...
  }, [active, geraetenummerCodes, geraetenummerPick.klasse]);
  ...
  }, [active, geraetenummerPick.klasse, geraetenummerPick.art]);
  ...
  }, [active, geraetenummerCodes, geraetenummerPick]);
  ...
  const formClassName =
    variant === "modal" ? "machineAddModal machineDetailPage" : "machineDetailPage";

  return (
    <form className={formClassName} onSubmit={handleSubmit} aria-labelledby="machine-add-title">
      <div className="machineAddModalHeader">
        <div>
          <h1 id="machine-add-title" className="machineAddModalTitle">
            Maschine hinzufügen
          </h1>
          <p className="subtitle">
            Neue Maschine — Gerätenummer aus Auswahl, alle Register erfassen.
          </p>
        </div>
        <button type="button" className="pillButton outline" onClick={onCancel}>
          Schließen
        </button>
      </div>
