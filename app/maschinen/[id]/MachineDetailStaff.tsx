...
import MachineStammdatenPanelContent, {
  buildStammdatenRowsForDisplay,
} from "../../components/MachineStammdatenPanelContent";
...
export default function MachineDetailStaff({ machineId }: { machineId: string }) {
  ...
  if (!authChecked) {
    return (
      <AppPageShell activeHref="/maschinen" subtitle="Betrieb">
