...
const FIELD_ALIASES = {
  ...
  artikelnummer: ["artikelnummer", "artikel nummer", "artikel-nr", "artikel nr"],
  bezeichnung: [
    "bezeichnung",
    "ersatzteil",
    "ersatzteile",
...
function rowToRecord(cells, headerMap) {
  ...
  if (!record.herstellernummer && record.artikelnummer) {
    record.herstellernummer = record.artikelnummer;
  }
