...
alter table public.maschines add column if not exists tpg_heben_technik_7_8_gultig_bis text;
alter table public.maschines add column if not exists elektro_ove_e8701_e8001_gultig_bis text;
...
alter table public.maschines add column if not exists intern_8_11_gultig_bis text;
alter table public.maschines add column if not exists paragraf_57a_gultig_bis text;
alter table public.maschines add column if not exists kennzeichen text;
alter table public.maschines add column if not exists std_zahler_getauscht_am text;
alter table public.maschines add column if not exists stundenzahlerstand_alt numeric;
alter table public.maschines add column if not exists letztes_service_am text;
alter table public.maschines add column if not exists letztes_service_von text;
alter table public.maschines add column if not exists frostschutz_gepruft_am text;
